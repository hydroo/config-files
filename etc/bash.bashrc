...
export PATH=$PATH:/opt/spin/bin
export PATH=$PATH:/opt/sun-java/bin
...
export GOBIN=/home/brendel/bin
export GOOS=linux
export GOARCH=amd64
export GOMAXPROCS=4

export MRMC_HOME_DIR=/opt/mrmc

#source /opt/intel-composer-XE-2013/bin/compilervars.sh intel64
#source /opt/intel-composer-XE-2013/inspector_xe/inspxe-vars.sh intel64 1> /dev/null
#source /opt/intel-composer-XE-2013/advisor_xe/advixe-vars.sh intel64 1> /dev/null
export INTEL_LICENSE_FILE=/opt/intel-composer-XE-2013/
